...
abstract class LocalStorage {
  ...
  List<String> get completedLessons =>
      getStringList(StorageKey.completedLessons.name) ?? [];
  set completedLessons(List<String> lessons) => setStringList(
        StorageKey.completedLessons.name,
        lessons,
      );

  List<String> get completedQuizzes =>
      getStringList(StorageKey.completedQuizzes.name) ?? [];
  set completedQuizzes(List<String> quizzes) => setStringList(
        StorageKey.completedQuizzes.name,
        quizzes,
      );
}
